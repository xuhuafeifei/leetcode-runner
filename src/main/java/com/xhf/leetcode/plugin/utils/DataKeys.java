...
public class DataKeys {
    ...
    public static final DataKey<MyList<String>> LEETCODE_DEBUG_VARIABLE_LIST = DataKey.create(
        "LEETCODE_DEBUG_VARIABLE_LIST");
     ...
     */
    public static final DataKey<MyList<Question>> LEETCODE_DEEP_CODING_HOT_100_QUESTION_LIST = DataKey.create(
        "LEETCODE_DEEP_CODING_HOT_100_QUESTION_LIST");
    /**
     * 获取interview 150 panel当前显示的数据
     */
    public static final DataKey<MyList<Question>> LEETCODE_DEEP_CODING_INTERVIEW_100_QUESTION_LIST = DataKey.create(
        "LEETCODE_DEEP_CODING_INTERVIEW_100_QUESTION_LIST");
    /**
     * 获取LC Competition Panel 当前显示的数据
     */
    public static final DataKey<MyList<CompetitionQuestion>> LEETCODE_DEEP_CODING_LC_COMPETITION_QUESTION_LIST = DataKey.create(
        "LEETCODE_DEEP_CODING_LC_COMPETITION_QUESTION_LIST");
    /**
