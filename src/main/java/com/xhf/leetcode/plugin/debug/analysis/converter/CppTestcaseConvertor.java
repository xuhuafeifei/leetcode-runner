 ...
 */
public class CppTestcaseConvertor extends AbstractTestcaseConvertor {

    public CppTestcaseConvertor(String instanceName, AnalysisResult result, Project project) {
    ...
    @Deprecated // for test
    public CppTestcaseConvertor(String instanceName, AnalysisResult result) {
