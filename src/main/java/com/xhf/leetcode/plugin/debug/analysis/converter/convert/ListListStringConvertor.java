...
public class ListListStringConvertor extends AbstractVariableConvertor {
    @Override
    protected String doCpp(String testcase, String variableName) {
        throw new NotSupportedException("cpp not support to convert List_List_String! test case = " + testcase);
    }

    @Override
    protected String doPython(String testcase, String variableName) {
        throw new NotSupportedException("python not support to convert List_List_String! test case = " + testcase);
    }
    ...
    protected String doJava(String testcase, String variableName) {
        ...
        sb.append("List<List<String>> ").append(variableName).append(" = new ArrayList<>();\n");
