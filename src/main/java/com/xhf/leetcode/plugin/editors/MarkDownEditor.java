...
public class MarkDownEditor implements FileEditor {
    ...
    private String questionWebUrl() {
        ...
        return "<a rel=\"stylesheet\" href=\"" + LeetcodeApiUtils.getQuestionUrl(titleSlug) + Constants.OPEN_ON_WBE + "\">" + BundleUtils.i18n("leetcode.web") + "</a><p>";
    }
...
//        String html = "<a rel=\"stylesheet\" href=\"" + LeetcodeApiUtils.getSolutionUrl(titleSlug, topicId, solutionSlug) + "\">在浏览器上访问</a><p>";
        return "> [" + BundleUtils.i18n("leetcode.web") + "](" + LeetcodeApiUtils.getSolutionUrl(titleSlug, topicId, solutionSlug) + Constants.OPEN_ON_WBE + ")";
    }
    ...
    public String getTag(String difficulty, String status) {
        ...
        */
        String color;
        String text;
        String[] easy = {BundleUtils.i18n("editor.markdown.easy1"), BundleUtils.i18n("editor.markdown.easy2"), BundleUtils.i18n("editor.markdown.easy3")};
        String[] medium = {BundleUtils.i18n("editor.markdown.medium1"), BundleUtils.i18n("editor.markdown.medium2"), BundleUtils.i18n("editor.markdown.medium3")};
        String[] hard = {BundleUtils.i18n("editor.markdown.hard1"), BundleUtils.i18n("editor.markdown.hard2"), BundleUtils.i18n("editor.markdown.hard3")};
