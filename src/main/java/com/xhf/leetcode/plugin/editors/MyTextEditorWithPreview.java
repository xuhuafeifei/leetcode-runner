...
public class MyTextEditorWithPreview extends UserDataHolderBase implements TextEditor {
  ...
  public MyTextEditorWithPreview(@NotNull TextEditor editor, @NotNull FileEditor preview, @NotNull @Nls String editorName) {
  ...
  private final class DoublingEventListenerDelegate implements PropertyChangeListener {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
      myDelegate.propertyChange(
        new PropertyChangeEvent(MyTextEditorWithPreview.this, evt.getPropertyName(), evt.getOldValue(), evt.getNewValue()));
    }
  }
