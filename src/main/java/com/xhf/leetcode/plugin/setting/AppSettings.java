...
public final class AppSettings
    ...
    public static final String REPOSITION_DEFAULT = BundleUtils.i18nHelper(LanguageConvertor.REPOSITION_DEFAULT_ZH,
        LanguageConvertor.REPOSITION_DEFAULT_EN);
    public static final String REPOSITION_SETTING = BundleUtils.i18nHelper(LanguageConvertor.REPOSITION_SETTING_ZH,
        LanguageConvertor.REPOSITION_SETTING_EN);
