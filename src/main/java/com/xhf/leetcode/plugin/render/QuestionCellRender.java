...
public class QuestionCellRender extends DefaultListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        if (isPaidOnly && !isSelected) {
            ...
            label.setBackground(new JBColor(new Color(bgColor.getRed(), bgColor.getGreen(), bgColor.getBlue(), 40), new Color(bgColor.getRed(), bgColor.getGreen(), bgColor.getBlue(), 40)));
